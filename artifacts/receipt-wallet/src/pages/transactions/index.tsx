...
export default function Transactions() {
  ...
  useEffect(() => {
    fetch("http://localhost:5001/api/transactions/vendors")
      .then((r) => r.json())
      .then(setVendors)
      .catch(() => {});
    fetch("http://localhost:5001/api/transactions/categories")
      .then((r) => r.json())
      .then(setCategories)
      .catch(() => {});
  }, []);
  ...
  useEffect(() => {
    if (showHidden) {
      fetch("http://localhost:5001/api/transactions/ignored")
        .then((r) => r.json())
        .then(setHiddenTxns)
        .catch(() => {});
    }
